...
//
//
#ifndef StorkNeutronHPIsoData_h
#define StorkNeutronHPIsoData_h 1
...
public:
  ...
  ~StorkNeutronHPIsoData(){if(theChannelData!=0) delete theChannelData;}
  ...
  void Init(G4int A, G4int Z, G4double abun, G4String dirName)  { G4int M =0;
  Init( A, Z, M, abun, dirName); };
  void Init(G4int A, G4int Z, G4int M, G4double abun, G4String dirName); //fill PhysicsVector for this Isotope
