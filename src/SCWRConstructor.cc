...
void SCWRConstructor::ConstructMaterials()
{
    ...
    *ZircSteel, *ZircHydrid, *OuterFuel, *InnerFuel, *H2O, *D2O, *Coolant, *Insulator;
    ...
    Pu->AddIsotope(Pu238, 2.75*perCent);
    Pu->AddIsotope(Pu239, 51.96*perCent);
    Pu->AddIsotope(Pu240, 22.96*perCent);
    Pu->AddIsotope(Pu241, 15.23*perCent);
    Pu->AddIsotope(Pu242, 7.10*perCent);
