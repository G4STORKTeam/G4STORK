...
// fixed the isotope compositon so that it is interms of abundance instead of weight percentage
    ...
    // Create Coolant
	Coolant = new G4Material("Coolant", coolantDensity, 1, kStateGas,
							 coolantTemp);
    ...
    CentralCoolant = new G4Material("CentralCoolant", centralCoolantDensity, 1, kStateGas, centralCoolantTemp);
